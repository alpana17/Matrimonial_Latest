<%-- 
    Document   : Delete_fail
    Created on : Jul 24, 2014, 3:59:14 AM
    Author     : Alpana
--%>
...
<html:html>
    ...
    <body bgcolor="antiquewhite" align="center"><br>
        ...
        <br><br>
        <p align="center">Delete failed due to some technical error.<br>
            Please try later..
         </p>
         <html:link href="Interested.jsp">Interested</html:link><br>
